...
#define STRING_CONFIG_H_AUTHOR "(EscapeKey)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Max"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // CR-10 Titan Aero PID Values
  #define  DEFAULT_Kp 14.19
  #define  DEFAULT_Ki 0.72
  #define  DEFAULT_Kd 69.76
...
#define MAX_BED_POWER 254 // limits duty cycle to bed; 255=full current
  ...
  //120V 750W Keenovo silicone heater PLUS Stock CR-10 bed
  #define DEFAULT_bedKp 289.82
  #define DEFAULT_bedKi 57.06
  #define DEFAULT_bedKd 367.99
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 836.50 }  // All 32 microsteps
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 418.25 }      // All 16 microsteps
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 200, 209 }      // All 8 microsteps
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 836.50 }    //16 microsteps for XYZ, 32 for E
/**
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define BACK_PROBE_BED_POSITION (Y_BED_SIZE - (MIN_PROBE_EDGE))
    ...
    #define BACK_PROBE_BED_POSITION ((Y_BED_SIZE - (MIN_PROBE_EDGE)) - 10)
